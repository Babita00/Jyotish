...
import DailyHoroscopeManager from '@/components/admin/DailyHoroscopeManager';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="bookings" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="horoscope" className={currentLanguage === 'ne' ? 'font-nepali' : ''}>
              {currentLanguage === 'ne' ? 'राशिफल' : 'Horoscope'}
            </TabsTrigger>
          ...
          <TabsContent value="bookings">
            <RoleGuard permission={PERMISSIONS.BOOKING_VIEW_ALL}>
          ...
          <TabsContent value="contacts">
            <RoleGuard permission={PERMISSIONS.USER_VIEW_ALL}>
              <Card className="shadow-lg border-0">
                <CardHeader>
                  <CardTitle className={currentLanguage === 'ne' ? 'font-nepali' : ''}>
          ...
          <TabsContent value="horoscope">
            <RoleGuard permission={PERMISSIONS.HOROSCOPE_CREATE}>
