  ...
  return (
    <div className="space-y-8">
        ...
        >
          {["khalti", "esewa", "fonepay"].map((method) => (
            ...
            >
              ...
              <label htmlFor={method} className="text-lg cursor-pointer">
                {method}
              </label>
            </div>
          ))}
          {formData.consultationType === "physical" && (
            <div className="flex items-center space-x-3 p-4 border rounded-lg hover:bg-gray-50">
              ...
              >
                {currentLanguage === "ne"
                  ? "भौतिक भेटमा भुक्तानी गर्नेछु"
                  : "Pay during physical visit"}
              </label>
            </div>
          )}
        </RadioGroup>
      ...
      {formData.paymentMethod &&
        !["later"].includes(formData.paymentMethod) && (
          <div className="space-y-6">
            ...
            <div>
              <input
                ...
                placeholder={
                  currentLanguage === "ne"
                    ? "Transaction ID प्रविष्ट गर्नुहोस्"
