...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      nameNe: "प्रिया शर्मा",
      textEn:
        "The marriage matching service was incredibly accurate. We found the perfect compatibility and are happily married now.",
      textNe:
        "विवाह मिलान सेवा अविश्वसनीय रूपमा सटीक थियो। हामीले उत्तम मेल फेला पार्यौं र अहिले खुशीसाथ विवाहित छौं।",
      rating: 5,
    },
    {
      nameEn: "Rajesh Thapa",
      nameNe: "राजेश थापा",
      textEn:
        "Career guidance helped me choose the right business timing. My business is flourishing exactly as predicted.",
      textNe:
        "करियर मार्गदर्शनले मलाई सही व्यापार समय छान्न मद्दत गर्यो। मेरो व्यापार भविष्यवाणी अनुसार नै फस्टाउँदै छ।",
      rating: 5,
    },
    {
      nameEn: "Sunita Rai",
      nameNe: "सुनिता राई",
      textEn:
        "The Kundali reading was very detailed and helpful. All predictions about my health and family came true.",
      textNe:
        "कुण्डली पढाइ धेरै विस्तृत र उपयोगी थियो। मेरो स्वास्थ्य र परिवारको बारेमा सबै भविष्यवाणी सत्य भयो।",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <AboutSection currentLanguage={currentLanguage} t={t} />
      <TestimonialsSection
