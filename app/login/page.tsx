...
export default function LoginPage() {
  ...
  const { signIn, profile } = useAuth(); // ✅ use profile for role
  ...
  const validateForm = () => {
    ...
    if (!formData.email) {
      newErrors.email =
        currentLanguage === "ne" ? "इमेल आवश्यक छ" : "Email is required";
    ...
    if (!formData.password) {
      newErrors.password =
        currentLanguage === "ne" ? "पासवर्ड आवश्यक छ" : "Password is required";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error.message ||
          (currentLanguage === "ne" ? "लगइन असफल भयो" : "Failed to login"),
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <Card className="w-full max-w-md border-0 shadow-lg">
        <CardHeader className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">
            {currentLanguage === "ne"
              ? "लगइन गरेर आफ्नो ज्योतिष खाता पहुँच गर्नुहोस्"
              : "Sign in to access your astrology account"}
          </p>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={
                    currentLanguage === "ne" ? "तपाईंको पासवर्ड" : "Your password"
                  }
